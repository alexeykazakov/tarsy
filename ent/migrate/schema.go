...
var (
	...
	TimelineEventsColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "event_type", Type: field.TypeEnum, Enums: []string{"llm_thinking", "llm_response", "llm_tool_call", "mcp_tool_summary", "error", "user_question", "executive_summary", "final_analysis", "code_execution", "google_search_result", "url_context_result", "task_assigned", "provider_fallback", "skill_loaded", "memory_injected", "claude_code"}},
